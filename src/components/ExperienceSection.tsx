...
const journey: RouteStop[] = [
  {
    id: '01',
    year: 'JAN - PRESENT 2026',
    title: 'SOFTWARE ENGINEER',
    organization: 'CAPGEMINI',
    description: 'Contributed to enterprise application development and software engineering projects at Capgemini, enhancing skills in coding, debugging, application development, testing, and professional development workflows.',
  },
  {
    id: '02',
    year: 'Jan - Mar 2026',
    title: 'C, C++ & LINUX TRAINING',
    organization: 'CAPGEMINI',
    description: 'Completed training in C, C++, and Linux, gaining hands-on experience in programming fundamentals, problem-solving, debugging, and working with Linux-based development environments.',
  },
  {
    id: '03',
    year: '2026',
    ...
    description: 'Earned Databricks Data Engineer certification, gaining knowledge of data engineering, ETL processes, and Apache Spark.',
  },
  {
    id: '04',
    year: '2025',
    ...
    description: 'Completed a web development bootcamp, gaining practical experience in HTML, CSS, JavaScript, responsive web design, and interactive webpage development.',
  },
  {
    id: '05',
    year: '2021 - 2025',
    ...
    description: 'Completed a Bachelor’s degree in Biomedical Engineering, gaining knowledge in medical devices, healthcare technologies, electronics, and engineering fundamentals.',
  },
];
